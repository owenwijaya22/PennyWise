...
public class TransactionAnalyzerTest {
    ...
    void testExpenseAnalysis() {
        ...
        testTransactions.add(new Transaction(TEST_USER_ID, 100.0, TransactionType.EXPENSE, ExpenseCategory.FOOD));
        testTransactions.add(new Transaction(TEST_USER_ID, 200.0, TransactionType.EXPENSE, ExpenseCategory.FOOD));
        testTransactions.add(new Transaction(TEST_USER_ID, 150.0, TransactionType.EXPENSE, ExpenseCategory.TRANSPORTATION));
    ...
    void testIncomeAnalysis() {
        ...
        testTransactions.add(new Transaction(TEST_USER_ID, 1000.0, TransactionType.INCOME, IncomeCategory.SALARY));
        testTransactions.add(new Transaction(TEST_USER_ID, 500.0, TransactionType.INCOME, IncomeCategory.BUSINESS));
        
        analyzer.updateTransactions(testTransactions);
        
        Map<Object, Double> incomeByCategory = analyzer.getIncomeByCategory();
    ...
    void testCategoryPercentages() {
        ...
        testTransactions.add(new Transaction(TEST_USER_ID, 100.0, TransactionType.EXPENSE, ExpenseCategory.FOOD));           // 25%
        testTransactions.add(new Transaction(TEST_USER_ID, 300.0, TransactionType.EXPENSE, ExpenseCategory.TRANSPORTATION)); // 75%
        
        analyzer.updateTransactions(testTransactions);
        
        Map<Object, Double> percentages = analyzer.getCategoryPercentages(TransactionType.EXPENSE);
